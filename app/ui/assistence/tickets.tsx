...
import { ITicket, TType } from "@/app/lib/definition";
import "../../globals.css";
...
export default function TicketSection({ openButtons }: { openButtons: () => void }) {
    return (
        <section className=" flex h-screen items-center justify-center flex-col p-3">
            <div className="h-full w-full bg-[#161616] rounded-lg overflow-hidden overflow-y-auto">
                ...
                <div className="w-full flex justify-start p-2 pb-4">
                    <button className="flex items-center text-gray-400 hover:text-indigo-400 transition-colors duration-200 text-sm font-semibold"
                        onClick={openButtons}
                    >
